...
///We have the grades of the students in different tasks for a subject in one line of the file.
///Data of one student can be in more than one lines of the file.
...
int main()
{
    try {
        ...
        cout << "Student who passed the least courses is " << pr.optElem().name << " with " << pr.opt() << " passed courses!";
