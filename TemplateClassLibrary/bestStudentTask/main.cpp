...
///Grades of students are given in a file. One line of the file contains name of the student and grade in
///one subject. File is ordered by student's name. Find the student with best average grade.
...
int main()
{
    try {
        ...
        if (pr.found())
        {
            cout << "Best student is " << pr.optElem().name << " with average: " << pr.optElem().avg <<endl;
        }
        else
        {
